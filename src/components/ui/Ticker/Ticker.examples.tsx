    ...
    <Container size="xl" py="xl">
      ...
      <Stack gap="xl">
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} bgColor="primary" textColor="white" />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} bgColor="light" textColor="dark" />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} bgColor="white" textColor="dark" />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} autoPlay={false} />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} autoPlayInterval={2000} />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} pauseOnHover={false} />
        </div>
        ...
        <div>
          ...
          <Ticker messages={sampleMessages} showNavigation={false} />
        </div>
        ...
        <div>
          ...
          <Button onClick={() => setShowFixedTicker(!showFixedTicker)} variant="outline">
